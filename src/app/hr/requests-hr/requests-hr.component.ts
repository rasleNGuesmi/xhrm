...
@Component({
  ...
  styleUrls: ['./requests-hr.component.scss']
})
export class RequestsHrComponent implements OnInit {
  // TODO DEPARTMENT
  ...
  retrieveAllRequests(): void {
    ...
    // TODO DOING
    this.orderService.getOrderByDepartment(this.department_id).subscribe((data: any) => {
