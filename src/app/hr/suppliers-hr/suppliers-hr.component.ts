...
@Component({
  selector: 'app-suppliers-hr',
  templateUrl: './suppliers-hr.component.html',
  styleUrls: ['./suppliers-hr.component.scss']
})
export class SuppliersHrComponent implements OnInit {
  // TODO DEPARTMENT
