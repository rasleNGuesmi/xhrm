...
@Component({
  selector: 'app-leave-secretary',
  templateUrl: './leave-secretary.component.html',
  styleUrls: ['./leave-secretary.component.scss']
})
export class LeaveSecretaryComponent implements OnInit {
  name: string;
