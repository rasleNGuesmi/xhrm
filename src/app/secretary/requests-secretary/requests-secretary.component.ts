...
@Component({
  selector: 'app-requests-secretary',
  templateUrl: './requests-secretary.component.html',
  styleUrls: ['./requests-secretary.component.scss']
})
export class RequestsSecretaryComponent implements OnInit {
