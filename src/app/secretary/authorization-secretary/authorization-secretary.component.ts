...
@Component({
  selector: 'app-authorization-secretary',
  templateUrl: './authorization-secretary.component.html',
  styleUrls: ['./authorization-secretary.component.scss']
})
export class AuthorizationSecretaryComponent implements OnInit {
  constructor(
