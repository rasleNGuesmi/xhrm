...
@Component({
  selector: 'app-periodical-secretary',
  templateUrl: './periodical-secretary.component.html',
  styleUrls: ['./periodical-secretary.component.scss']
})
export class PeriodicalSecretaryComponent implements OnInit {
