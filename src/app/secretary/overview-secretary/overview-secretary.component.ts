...
@Component({
  selector: 'app-overview-secretary',
  templateUrl: './overview-secretary.component.html',
  styleUrls: ['./overview-secretary.component.scss']
})
export class OverviewSecretaryComponent implements OnInit {
