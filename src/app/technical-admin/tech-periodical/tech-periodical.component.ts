...
import {TechUpdateExpenseComponent} from "../../shared/modals/tech-update-expense/tech-update-expense.component";

@Component({
  selector: 'app-tech-periodical',
  templateUrl: './tech-periodical.component.html',
  styleUrls: ['./tech-periodical.component.scss']
})
export class TechPeriodicalComponent implements OnInit {
  ...
  displayedColumns = ['expense_name', 'enterprise', 'period', 'amount', 'date', ' '];
  ...
  openDialogUpdate(row: any): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      const dialogRef = this.dialog.open(TechUpdateExpenseComponent, {
        data: { expense: row },
      });
